# TradingAgents/tradingagents/agents/src/tools/api.py
import datetime
import logging
import os
import pandas as pd
import requests
import time
import inspect   # 新增，用于获取调用栈

logger = logging.getLogger(__name__)

from tradingagents.agents.src.data.cache import get_cache
from tradingagents.agents.src.data.models import (
    CompanyNews,
    CompanyNewsResponse,
    FinancialMetrics,
