# /data/lishuaibing/valueagents/ValueAgents/valueagents/dataflows/interface.py
...
- 它位于 valueagents/dataflows/ 目录下（从导入路径 .y_finance、.yfinance_news 可以看出），扮演了数据供应商路由层的角色。核心机制如下：
